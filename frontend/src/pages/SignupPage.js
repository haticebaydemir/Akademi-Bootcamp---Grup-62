...
const SignupPage = () => {
    ...
    switch (name) {
      case 'name':
        if (!value) {
          ...
          error = 'Ad soyad sadece harf içerebilir';
        }
        break;
      case 'email':
        if (!value) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.removeItem('signupFormData');
      // Reset form after success and redirect to login
      setTimeout(() => {
        setFormData({ name: '', email: '', password: '', confirmPassword: '' });
        setShowSuccess(false);
        navigate('/login');
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (response) => {
      try {
        ...
        // Örnek: await signupWithGoogle(userInfo);
        
      } catch (error) {
        console.error('Google Signup Error:', error);
        setShowError(true);
        setErrorMessage('Google ile kayıt olurken bir hata oluştu');
        setShowSuccess(false);
      }
    },
    onError: (error) => {
      console.error('Google Signup Error:', error);
      setShowError(true);
      setErrorMessage('Google ile kayıt olunamadı');
      setShowSuccess(false);
    }
  });
    ...
    <div className="min-h-screen bg-complementary flex font-sans overflow-hidden transition-colors duration-300 relative">
      ...
      {showSuccess && (
        <div className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 animate-slide-down">
          <div className="flex items-center gap-3 bg-green-100 dark:bg-green-900/50 border border-green-300 dark:border-green-700 text-green-800 dark:text-green-200 px-6 py-3 rounded-lg shadow-lg">
            ...
            <span>Hesap başarıyla oluşturuldu! Giriş sayfasına yönlendiriliyorsunuz...</span>
          </div>
        </div>
      )}
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="animate-slide-up delay-200">
            ...
            >
              ...
              <span className="text-gray-700 dark:text-gray-200 text-sm font-medium group-hover:text-gray-800 dark:group-hover:text-white transition-colors duration-300">Google ile Kayıt Ol</span>
            </button>
          </div>
          ...
          <div className="relative animate-slide-up delay-300">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-300">veya e-posta ile kayıt olun</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 animate-slide-up delay-400">
            <div className="space-y-2 group">
              <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                Ad Soyad
              </label>
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-300 text-base hover:border-gray-400 dark:hover:border-gray-500 focus:shadow-lg dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 ${
                    errors.name 
            ...
            <div className="space-y-2 group">
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                E-posta Adresi
              </label>
              <div className="relative">
                <input
            ...
            <div className="space-y-2 group">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-300 text-base hover:border-gray-400 dark:hover:border-gray-500 focus:shadow-lg dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 ${
                    errors.password 
                      ? 'border-red-500 dark:border-red-400 focus:ring-red-500 dark:focus:ring-red-400' 
                      : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400'
                  }`}
            ...
            <div className="space-y-2 group">
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                Şifre Tekrarı
              </label>
              <div className="relative">
                <input
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative mt-1">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 dark:text-blue-400 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400 transition-all duration-300"
                  />
                  <div className="absolute inset-0 rounded bg-blue-500 opacity-0 group-hover:opacity-10 dark:group-hover:opacity-20 transition-opacity duration-300 pointer-events-none"></div>
                </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="group w-full bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 hover:from-blue-700 hover:to-blue-800 dark:hover:from-blue-600 dark:hover:to-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 text-base transform hover:scale-105 hover:shadow-xl dark:hover:shadow-blue-500/25 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-400/50 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
          ...
          {/* Demo Info and Login Link */}
          <div className="text-center animate-slide-up delay-600">
            <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Demo Hesap Bilgileri:</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">
                E-posta: <span className="font-mono">demo@example.com</span> | Şifre: <span className="font-mono">demo123</span>
              </p>
            </div>
            
            <div className="flex items-center justify-center gap-4">
              <span className="text-gray-600 dark:text-gray-400 text-sm">Zaten hesabınız var mı? </span>
              <button 
            ...
            {(formData.name || formData.email || formData.password || formData.confirmPassword) && (
              <button
                onClick={clearForm}
                className="mt-3 text-xs text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors duration-300"
              >
                Formu Temizle
              </button>
            )}
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 items-center justify-center p-8 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-32 h-32 bg-blue-200 dark:bg-blue-900/30 rounded-full blur-3xl animate-float opacity-30"></div>
          <div className="absolute bottom-20 right-20 w-24 h-24 bg-purple-200 dark:bg-purple-900/30 rounded-full blur-2xl animate-float-delayed opacity-30"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-indigo-200 dark:bg-indigo-900/20 rounded-full blur-3xl animate-pulse opacity-20"></div>
        </div>
